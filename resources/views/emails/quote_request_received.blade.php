                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="width:100%; border-collapse:collapse;">
                                ...
                                <tr>
                                    ...
                                    <td style="padding:14px 0; border-top:1px solid #f3f4f6; color:#111827; font-size:15px; line-height:22px;">
                                        <a href="mailto:{{ $quoteRequest->email }}" style="color:#b91c1c; text-decoration:none; font-weight:700;">
                                            {{ $quoteRequest->email }}
                                        </a>
                                    </td>
                                </tr>
                                @if($quoteRequest->phone)
                                    <tr>
                                        ...
                                        <td style="padding:14px 0; border-top:1px solid #f3f4f6; color:#111827; font-size:15px; line-height:22px;">
                                            <a href="tel:{{ preg_replace('/[^0-9+]/', '', $quoteRequest->phone) }}" style="color:#111827; text-decoration:none;">
                                                {{ $quoteRequest->phone }}
                                            </a>
                                        </td>
                                    </tr>
                                ...
                                <tr>
                                    ...
                                    <td style="padding:14px 0; border-top:1px solid #f3f4f6; color:#111827; font-size:15px; line-height:22px;">
                                        {{ $quoteRequest->service_needed_by }}
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding:14px 0; border-top:1px solid #f3f4f6; width:150px; color:#6b7280; font-size:13px; line-height:20px; font-weight:700; text-transform:uppercase;">
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" style="margin-top:26px;">
                                <tr>
                                    <td style="background:#b91c1c; border-radius:8px;">
                                        <a href="mailto:{{ $quoteRequest->email }}" style="display:inline-block; padding:12px 18px; color:#ffffff; font-size:14px; line-height:20px; font-weight:700; text-decoration:none;">
